...
// Analog IR Functions
void initializeIR() { // Initialize all pins for analog ir sensors
  pinMode(IRPIN1, INPUT);
  pinMode(IRPIN2, INPUT);
}
void checkIR() {  // check both IR pins for an obstacle
...
void ir() { // Function on how to move after IR detects something
  backward();
  delay(500);
  off();
  delay(200);
